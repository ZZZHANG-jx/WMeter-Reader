...
class TexttextLoader_im(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        im_path = os.path.join('./data/datas',name)
        ...
        ## predict
        # if len(predicts[0])>2:
        #     predicts,gts,images,center_xs,center_ys = self.zilun2zhizhen_predict(predicts,gts,images,center_xs,center_ys)  

        # print(predicts,gts,name)
        # if len(gts)!=len(predicts):
        #     print(name,len(gts),gts,predicts)
        ...
        if len(predicts)<12:
            ...
            images = images + [np.zeros((64,64,3))]*(12-predict_num)
        ...
        return src.numpy(),tgt.numpy(),src_im.numpy(),src_x.numpy(),src_y.numpy()
